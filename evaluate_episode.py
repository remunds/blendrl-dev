...
def main():
    ...
    mod = ["first_level_only", "ropes"]
    env = NudgeBaseEnv.from_name(env_name, mode='eval', episodic_life=False, modified_env=mod)
    ...
    agent = BlendrlRLAgent(env, checkpoint_path, env_name=env_name, device="cpu", env_kwargs={"modified_env": mod})
